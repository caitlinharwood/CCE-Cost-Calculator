...
if uploaded_file is not None:
    ...
    st.write("The purpose of this tool is to provide a visual demonstration of the savings available by implementing fixed or tracking solar arrays to existing parking structures. For more information, please visit centerforcommunityenergy.org/")
